...
export default function AudioWhisper(): JSX.Element {
  ...
  return (
    <div style={{ marginBottom: "30px" }}>
      ...
      >
        ...
        <br />
        <strong>Features:</strong> Transcription and translation using OpenAI
        Whisper
      </div>
    </div>
  );
